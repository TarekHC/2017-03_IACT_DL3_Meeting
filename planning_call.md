...
* Tarek Hassan - a proposal how to support point-like IRFs (https://github.com/open-gamma-ray-astro/gamma-astro-data-formats/pull/79)
  * You can find the proposed new format in a HTML format in the following link: http://www.gae.ucm.es/~thassan/gamma/irfs/index.html
  * There is also an on-going discussion about `HDUCLAS` hierarchy, which also happened in the past in this issue: https://github.com/open-gamma-ray-astro/gamma-astro-data-formats/issues/71 
